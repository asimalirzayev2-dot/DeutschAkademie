...
// ---- Anon patch (RLS açıq olan cədvəllər üçün, məs. live_game_players) ----
...
// ---- RPC (Postgres funksiyaları, məs. admin_set_premium) ----
export async function sbAuthRpc(fnName, accessToken, params = {}) {
